...
import { apiUpload } from "../../services/httpClient";
...
const handleImageSelect = useCallback(async (event) => {
  ...
  if (import.meta.env.DEV) {
    if (import.meta.env.DEV) { console.log('📁 File selected:', { name: file.name, size: `${(file.size / 1024).toFixed(2)} KB`, type: file.type }); }
  }
  ...
  try {
    ...
    const data = await apiUpload('/users/me/avatar', formData, 'POST');
